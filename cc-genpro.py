...
def usage():
    ...
    print("\033[1;31m")
    print("+---------------+")
    print("+\033[;32m Editado por DUANER\033[1;31m +")
    print("+---------------+\033[0m")
    print("")
    print("\033[1;33m Nickname: DUANER\033[0m")
    print("\033[1;33m Youtube: NO TENGO PE CAUSHA\033[0m")
    print("\033[1;33m Telegram: TAMPOCO TENGO  \033[0m")
    print("\033[1;33m Facebook: MUCHO MENOS :v")
    print("")
